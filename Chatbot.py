...
def send_message(message):
    try:
        ...
        print(e)
        c.privmsg(f'#{channel}', "...I'm sorry, I spaced out, what are we talking about?")
...
def timed_message():
    ...
    while True:
        ...
        #     message_count = 0
            #send_message("Come to the Forever Rolling discord server, and join in our Jolly Cooperation! https://discord.gg/AjqUSfcd3r")
        send_message(random.choice(lore))
        time.sleep(600)
...
def generate_response(message):
    ...
    try:
        response = Openai_client.chat.completions.create(
            ...
            "content": "You are the Sapphire Herald, a calm, friendly woman who is the assistant of Lorekeeper Wilveren. Please summarize to keep responses brief."
            },
            {
                "role": "user",
                "content": message
        ...
        print(e)
        return "...I'm sorry, I spaced out, what are we talking about?"
